package POE::Component::IRC::Plugin::CPAN::LinksToDocs::No404s;
...
sub _make_default_args {
    return (
        ...
        linker           => CPAN::LinksToDocs::No404s->new,
        max_length       => 300,
    );
}
...
sub _make_poco {
    my $self = shift;
    return POE::Component::CPAN::LinksToDocs::No404s->spawn(
        debug  => $self->{debug},
        linker => $self->{linker},
    );
}
...
C<POE::Component::IRC::Plugin::CPAN::LinksToDocs::No404s> object suitable to be
...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-cpan-linkstodocs-no404s at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-CPAN-LinksToDocs-No404s>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-CPAN-LinksToDocs-No404s>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-CPAN-LinksToDocs-No404s>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-CPAN-LinksToDocs-No404s>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-CPAN-LinksToDocs-No404s>
